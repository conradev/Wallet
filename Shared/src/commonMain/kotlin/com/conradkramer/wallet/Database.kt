...
import com.conradkramer.wallet.data.Ens_lookup
import com.conradkramer.wallet.data.Ens_reverse_lookup
...
import com.conradkramer.wallet.data.Erc721_token
...
private val coinAdapter = object : ColumnAdapter<Coin, Long> {
    override fun decode(databaseValue: Long) = Coin(databaseValue.toInt())
